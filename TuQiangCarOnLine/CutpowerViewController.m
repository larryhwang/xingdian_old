...
@interface CutpowerViewController () <WebServiceProtocol, RadioButtonDelegate, UIAlertViewDelegate>
...
@implementation CutpowerViewController

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        self.title = MyLocal(@"断电报警设置");
        self.alarmtType = @"1";
    }
    return self;
}
...
//    RadioButton *OnButton = [[RadioButton alloc] initWithGroupId:@"switch" index:0];
//    OnButton.frame = CGRectMake(30, 54, 22, 22);
//    OnButton.button.selected = YES;
//    [self.view addSubview:OnButton];
//    UILabel *onlabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 50, 50, 30)];
//    onlabel.text = MyLocal(@"开");
//    onlabel.font = [UIFont systemFontOfSize:17.0f];
//    onlabel.backgroundColor = [UIColor clearColor];
//    [self.view addSubview:onlabel];
//    
//    RadioButton *OffButton = [[RadioButton alloc] initWithGroupId:@"switch" index:1];
//    OffButton.frame = CGRectMake(30, 84, 22, 22);
//    [self.view addSubview:OffButton];
//    UILabel *offlabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 80, 50, 30)];
//    offlabel.text = MyLocal(@"关");
//    offlabel.font = [UIFont systemFontOfSize:17.0f];
//    offlabel.backgroundColor = [UIColor clearColor];
//    [self.view addSubview:offlabel];
//    
//    [RadioButton addObserverForGroupId:@"switch" observer:self];
    
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(20, 130, 160, 30)];
    label2.text = MyLocal(@"断电报警上传方式:");
    label2.font = [UIFont systemFontOfSize:17.0f];
    label2.textAlignment = NSTextAlignmentLeft;
    label2.backgroundColor = [UIColor clearColor];
    [self.view addSubview:label2];
    
    RadioButton *radioButton1 = [[RadioButton alloc] initWithGroupId:@"cutpowerSet" index:0];
    radioButton1.frame = CGRectMake(30, 164, 22, 22);
    [self.view addSubview:radioButton1];
    UILabel *typeLabel1 = [[UILabel alloc]initWithFrame:CGRectMake(60, 160, 150, 30)];
    ...
    RadioButton *radioButton2 = [[RadioButton alloc]initWithGroupId:@"cutpowerSet" index:1];
    radioButton2.frame = CGRectMake(30, 204, 22, 22);
    radioButton2.button.selected = YES;
    [self.view addSubview:radioButton2];
    UILabel *typeLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(60, 200, 150, 30)];
    ...
    RadioButton *radioButton3 = [[RadioButton alloc]initWithGroupId:@"cutpowerSet" index:2];
    radioButton3.frame = CGRectMake(30, 244, 22, 22);
    [self.view addSubview:radioButton3];
    UILabel *typeLabel3 = [[UILabel alloc]initWithFrame:CGRectMake(60, 240, 250, 30)];
    ...
    [RadioButton addObserverForGroupId:@"cutpowerSet" observer:self];
    ...
    [button1 addTarget:self action:@selector(setCutpowerAlarm) forControlEvents:UIControlEventTouchUpInside];
...
- (void)setCutpowerAlarm
{
    ...
    WebServiceParameter *parameter2 = [WebServiceParameter newWithKey:@"Type" andValue:@"23"];
