...
@interface LowpowerViewController () <WebServiceProtocol, RadioButtonDelegate, UIAlertViewDelegate>
...

{
    ...
    label2.text = MyLocal(@"低电报警上传方式:");
    label2.font = [UIFont systemFontOfSize:17.0f];
    label2.textAlignment = NSTextAlignmentLeft;
    label2.backgroundColor = [UIColor clearColor];
    [self.view addSubview:label2];
    
    RadioButton *radioButton1 = [[RadioButton alloc] initWithGroupId:@"lowpowerSet" index:0];
    ...
    RadioButton *radioButton2 = [[RadioButton alloc]initWithGroupId:@"lowpowerSet" index:1];
...
//    [self.view addSubview:typeLabel3];
    ...
    [RadioButton addObserverForGroupId:@"lowpowerSet" observer:self];
...
- (void)setCutpowerAlarm
{
    ...
    WebServiceParameter *parameter2 = [WebServiceParameter newWithKey:@"Type" andValue:@"22"];
