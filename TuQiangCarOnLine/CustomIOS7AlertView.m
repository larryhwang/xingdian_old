...
const static CGFloat kCustomIOS7AlertViewCornerRadius              = 8;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:0 green:0.5 blue:1.0 alpha:1.0] forState:UIControlStateNormal];
